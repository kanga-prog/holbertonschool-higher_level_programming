...
def lookup(obj):
    """
    This function returns a list of available attributes and methods of the given object.
    It uses the built-in dir() function to gather and return all the attributes and
    methods that belong to the object, including special methods like __init__ and __str__.
