...
La fonction compare l'objet avec la classe spécifiée\
      et retourne `True` si l'objet
...
La fonction ne prend pas en compte l'héritage,\
      elle vérifie uniquement l'appartenance
directe à la classe.
